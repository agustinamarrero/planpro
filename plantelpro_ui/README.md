## Plantelpro UI package

Plantelpro UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── plantelpro_icons_dark.dart
│   │       │      ├── plantelpro_icons_light.dart
│   │       │      └── plantelpro_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── plantelpro_app_bar.dart
│   │             ├── plantelpro_outlined_button.dart
│   │             └── plantelpro_text_field.dart 
│   ├── plantelpro_ui.dart
│   ├── .gitignore
...
1) Inside `plantelpro_icons.dart`:
...
```
2) In `plantelpro_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `plantelpro_icons_dark.dart` add the icon with its color respectively of the theme. 
